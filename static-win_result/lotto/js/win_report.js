...
function ResultContent(dateFrom, ToDate) {
    ...
    var settings = {
        "async": true,
        "crossDomain": true,
        "url": api + "keno/bet_list/?bet_option={2}&fdate={0}&tdate={1}&page_size=4000".format(dateFrom, ToDate, 'lotto5d'),
        "method": "GET",
        "headers": {
...
function _addEventDatePicker() {
    $("#txtDateFrom").datepicker({
        showOn: "both",
        buttonImage: "/static-win_result/user_portal/assets/icon_v2.gif",
        dateFormat: 'dd-mm-yy',
