...
! function(a, b) {
    ...
    b.defaults = {
        ...
        open: function(c, d) {
            ...
            var j, k;
            for (j in c) k = a.extend({}, b.defaults.state, {
                name: j
            }, c[j]), e.addState(k.name, k), "" === e.currentStateName && (e.currentStateName = k.name);
            e.jqi.on("click", "." + f.prefix + "buttons button", function(b) {
                ...
                if (e.options.buttonTimeout > 0 && (e.disableStateButtons(g), setTimeout(function() {
                    ...
                    }, e.options.buttonTimeout)), void 0 === j)
                    for (var l in h.buttons)(h.buttons[l].title === c.text() || h.buttons[l].title === c.html()) && (j = h.buttons[l].value);
            ...
            var l = function() {
                    if (f.persistent) {
                        var b = f.top.toString().indexOf("%") >= 0 ? h.height() * (parseInt(f.top, 10) / 100) : parseInt(f.top, 10),
                ...
                m = function(b) {
                    ...
                    if (27 === c && l(), 13 === c) {
                        var d = e.getCurrentState().find("." + f.prefix + "defaultbutton"),
                            g = a(b.target);
            ...
            return e.position(), e.style(), e._windowResize = function(a) {
                ...
                animate: !1
            }, e._windowResize), e.jqif.click(l), e.jqi.find("." + f.prefix + "close").click(function() {
                e.close()
        ...
        addState: function(c, d, e) {
            var f, g, h, i, j, k = this,
                ...
                s = [],
                t = 0;
            if (d = a.extend({}, b.defaults.state, {
                    name: c
                }, d), a.isPlainObject(q) && null !== q.arrow && (n = '<div class="' + p.prefix + "arrow " + p.prefix + "arrow" + q.arrow + '"></div>'), d.title && "" !== d.title && (o = '<div class="lead ' + p.prefix + "title " + p.classes.title + '">' + d.title + "</div>"), f = d.html, "function" == typeof d.html && (f = "Error: html function must return text"), l += '<div class="' + p.prefix + 'state" data-jqi-name="' + c + '">' + n + o + '<div class="' + p.prefix + "message " + p.classes.message + '">' + f + '</div><div class="' + p.prefix + "buttons" + (a.isEmptyObject(d.buttons) ? "hide " : " ") + p.classes.buttons + '">', a.isArray(d.buttons)) s = d.buttons;
            else if (a.isPlainObject(d.buttons))
                for (h in d.buttons) d.buttons.hasOwnProperty(h) && s.push({
                    title: h,
                    value: d.buttons[h]
                });
            ...
            return l += "</div></div>", m = a(l).css({
                display: "none"
            }), m.on("impromptu:submit", d.submit), void 0 !== e ? k.getState(e).after(m) : r.append(m), k.options.states[c] = d, m
        },
        ...
        position: function(b) {
            var c = this,
                ...
                g = f ? a.isFunction(f.position) ? f.position() : f.position : void 0,
                h = a(window),
            ...
            if (void 0 !== b && b.data.animate === !1 && (a.fx.off = !0), c.jqib.css({
                    position: "absolute",
                    height: k,
                    width: "100%",
                    top: 0,
                ...
                var n = a(g.container).offset(),
                    o = !1;
                a.isPlainObject(n) && void 0 !== n.top && (m = n.top + g.y - (c.options.top.toString().indexOf("%") >= 0 ? j * (parseInt(c.options.top, 10) / 100) : parseInt(c.options.top, 10)), c.jqi.css({
                    position: "absolute"
                }), c.jqi.animate({
                    top: n.top + g.y,
                    left: n.left + g.x,
                    ...
                    !o && n.top + g.y + c.jqi.outerHeight(!0) > l + j && (a("html,body").animate({
                        scrollTop: m
                    }, "slow", "swing", function() {}), o = !0)
                }), (l > m || m > l + j) && (a("html,body").animate({
                    scrollTop: m
                }, "slow", "swing", function() {}), o = !0))
            } else g && g.width ? (c.jqi.css({
                position: "absolute",
                left: "50%"
            }), c.jqi.animate({
                top: g.y || m,
