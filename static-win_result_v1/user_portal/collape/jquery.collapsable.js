...
(function($) {
    ...
    function handleExpandCollapse(action, collapsableEvent, data) {
        ...
        var event = $.Event(trigger + '.collapsable', {
            customData: data,
            collapsableEvent: collapsableEvent
        });
        ...
        this.parent.$extLinks
            .filter('[href="#' + this.id + '"]')[action === 'expand' ? 'addClass' : 'removeClass'](opts.classNames.extLinkActive);
    ...
    CollapsableItem.prototype.expand = function(collapsableEvent, data, force) {
        ...
        var event = $.Event('expand.collapsable', {
            customData: data,
            collapsableEvent: collapsableEvent
        });
    ...
    CollapsableItem.prototype.collapse = function(collapsableEvent, data, force) {
        ...
        var event = $.Event('collapse.collapsable', {
            customData: data,
            collapsableEvent: collapsableEvent
        });
        this.$collapsable.trigger(event);
